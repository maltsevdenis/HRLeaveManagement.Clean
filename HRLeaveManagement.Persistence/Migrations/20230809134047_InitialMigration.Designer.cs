...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20230809134047_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 8, 9, 16, 40, 47, 569, DateTimeKind.Local).AddTicks(8674),
                            DateModified = new DateTime(2023, 8, 9, 16, 40, 47, 569, DateTimeKind.Local).AddTicks(8718),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
