...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20230914104104_AddedStartEndDateLeaveRequest")]
    partial class AddedStartEndDateLeaveRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 9, 14, 13, 41, 4, 225, DateTimeKind.Local).AddTicks(9272),
                            DateModified = new DateTime(2023, 9, 14, 13, 41, 4, 225, DateTimeKind.Local).AddTicks(9315),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
